...
print(add_book_in_library(BookBase("fdd", "dgtgt", 2998)))
print(delete_book_in_library(995268))
print(find_book_in_library(title="fd"))

print(delete_book_in_library('ZU-54224'))

print(find_book_in_library('fdd'))
print(get_all_books_in_library())

print(change_book_status(book_id='PX-89190', status=False))
